...
d.vax <- read.table("data/LAC_Vaccine_City_Data.csv", header=T, sep=",") %>% 
  mutate()
...
<!-- ## Full model parameter estimates over time {.tabset} -->

<!-- In models, vaccination rates are lagged 14 days in relation to the Covid incidence rate (e.g. models for 2021/10/15 includes IR from 10/15 but vaccination rates from 10/01)  -->
